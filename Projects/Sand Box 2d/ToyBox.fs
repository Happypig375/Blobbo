    ...
    override this.Process (selectionResults, toyBox, world) =
        ...
        if toyBox.GetSelected world then
            ...
            World.doStaticSprite "Background"
                // EyeMarginMaxScalar permits a viewing margin on each side, measured relative to Eye2dSize.
                // Eye2dViewable includes the maximum configured margin so the background covers the viewed area.
